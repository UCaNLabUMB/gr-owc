...
#ifndef INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CVOLK_H
#define INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CVOLK_H
 ...
 *
 */
class OWC_API OWC_Channel_absolute_cvolk : virtual public gr::sync_block {
public:
  typedef std::shared_ptr<OWC_Channel_absolute_cvolk> sptr;

  /*!
   * \brief Return a shared_ptr to a new instance of
   * owc::OWC_Channel_absolute_cvolk.
   *
   * To avoid accidental use of raw pointers, owc::OWC_Channel_absolute_cvolk's
   * constructor is in a private implementation
   * class. owc::OWC_Channel_absolute_cvolk::make is the public interface for
...
#endif /* INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CVOLK_H */
