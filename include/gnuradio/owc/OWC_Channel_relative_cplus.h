...
#ifndef INCLUDED_OWC_OWC_CHANNEL_RELATIVE_CPLUS_H
#define INCLUDED_OWC_OWC_CHANNEL_RELATIVE_CPLUS_H
 ...
 *
 */
class OWC_API OWC_Channel_relative_cplus : virtual public gr::sync_block
{
public:
    typedef std::shared_ptr<OWC_Channel_relative_cplus> sptr;

    /*!
     * \brief Return a shared_ptr to a new instance of owc::OWC_Channel_relative_cplus.
     *
     * To avoid accidental use of raw pointers, owc::OWC_Channel_relative_cplus's
     * constructor is in a private implementation
     * class. owc::OWC_Channel_relative_cplus::make is the public interface for
...
#endif /* INCLUDED_OWC_OWC_CHANNEL_RELATIVE_CPLUS_H */
