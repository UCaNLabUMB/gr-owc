...
#ifndef INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CPLUS_IMPL_H
#define INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CPLUS_IMPL_H
...
class OWC_Channel_absolute_cplus_impl : public OWC_Channel_absolute_cplus {
private:
    int d_num_inputs = 1;
    int d_num_outputs = 1;
...
#endif /* INCLUDED_OWC_OWC_CHANNEL_ABSOLUTE_CPLUS_IMPL_H */
