...
try:
    from gnuradio.owc import OWC_Channel_absolute_cvolk
except ImportError:
    import os
    import sys
...
class qa_OWC_Channel_absolute_cvolk(gr_unittest.TestCase):
    ...
    def test_instance(self):
        instance = OWC_Channel_absolute_cvolk(1,1,[1,2,5],[0,0,-1],[2,2,0],[0,0,1],[2],[1],[1],[1],True,True,1000,1,[90],[1],[1])
    ...
    def test_001_Channel_absolute(self):
        ...
        blk = OWC_Channel_absolute_cvolk(1,1,[1,2,5],[0,0,-1],[2,2,0],[0,0,1],[2],[1],[1],[1],True,False,1000,1,[90],[1],[1])
    ...
    def test_002_Channel_absolute(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OWC_Channel_absolute_cvolk(1,1,[10,10,10],[-1,0,-1],[4,4,4],[0,0,1],[2],[1],[1],[1],True,True,1000,1,[90],[1],[1])
        dst = blocks.vector_sink_f()
    ...
    def test_003_Channel_absolute(self):
        ...
        op = OWC_Channel_absolute_cvolk(2,2,[10,10,10,8,8,8],[0,0,-1,0,-1,-1],[2,2,2,3,4,4],[0,0,1,1,0,1],[2,3],[1,2],[1,1],[1,1],False,False,1000,1,[90,90],[1,1],[1,1])
    ...
    def test_004_Channel_absolute(self):
        ...
        op = OWC_Channel_absolute_cvolk(2,2,[10,10,10,8,8,8],[0,0,-1,0,-1,-1],[10,10,10,3,4,4],[0,0,1,1,0,1],[2,3],[1,2],[1,1],[1,1],False,False,1000,1,[90,90],[1,1],[1,1])
        self.help3_ff((src1_data, src2_data), (expected_result1, expected_result2), op)
    ...
    def test_005_Channel_absolute(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OWC_Channel_absolute_cvolk(1,1,[10,10,10],[-1,0,-1],[4,4,4],[0,0,1],[2],[1],[1],[1],True,False,1000,1,[90],[1],[1])
        dst = blocks.vector_sink_f()
    ...
    def test_006_Channel_absolute(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OWC_Channel_absolute_cvolk(1,1,[10,10,10],[-1,0,-1],[4,4,4],[0,0,1],[2],[1],[1],[1],False,False,1000,1,[90],[1],[1])
        dst = blocks.vector_sink_f()
