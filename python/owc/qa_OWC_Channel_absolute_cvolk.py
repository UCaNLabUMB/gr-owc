...
class qa_OWC_Channel_absolute_cvolk(gr_unittest.TestCase):
    ...
    def test_instance(self):
        instance = OWC_Channel_absolute_cvolk(1,1,[1,2,5],[0,0,-1],[2,2,0],[0,0,1],[2],[1],[1],[1],[90],[1],[1])
    ...
    def test_001_Channel_absolute(self):
        ...
        blk = OWC_Channel_absolute_cvolk(1,1,[1,2,5],[0,0,-1],[2,2,0],[0,0,1],[2],[1],[1],[1],[90],[1],[1])
    ...
    def test_002_Channel_absolute(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OWC_Channel_absolute_cvolk(1,1,[10,10,10],[-1,0,-1],[4,4,4],[0,0,1],[2],[1],[1],[1],[90],[1],[1])
        dst = blocks.vector_sink_f()
