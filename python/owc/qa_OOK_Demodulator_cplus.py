...
try:
    from gnuradio.owc import OOK_Demodulator_cplus
except ImportError:
    import os
    import sys
...
class qa_OOK_Demodulator_cplus(gr_unittest.TestCase):
    ...
    def test_instance(self):
        ...
        instance = OOK_Demodulator_cplus(0.5, 1)
    ...
    def test_002_OOK_Demod(self):
        ...
        src = blocks.vector_source_f(src_data)
        blk = OOK_Demodulator_cplus(1.75,2)
        dst = blocks.vector_sink_f()
    ...
    def test_003_OOK_Demod(self):
        ...
        src = blocks.vector_source_f(src_data)
        blk = OOK_Demodulator_cplus(15,4)
        dst = blocks.vector_sink_f()
    ...
    def test_004_OOK_Demod(self):
        ...
        src = blocks.vector_source_f(src_data)
        blk = OOK_Demodulator_cplus(50,5)
        dst = blocks.vector_sink_f()
    ...
    def test_005_OOK_Demod(self):
        ...
        src = blocks.vector_source_f(src_data)
        blk = OOK_Demodulator_cplus(0.5,4)
        dst = blocks.vector_sink_f()
...
if __name__ == '__main__':
    gr_unittest.run(qa_OOK_Demodulator_cplus)
