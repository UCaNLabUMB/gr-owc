...
from gnuradio.owc import OOK_Modulator_Python

class qa_OOK_Modulator_Python(gr_unittest.TestCase):
    ...
    def test_instance(self):
        instance = OOK_Modulator_Python(1.0, 0.0, 1)
    ...
    def test_001_OOK(self):
        ...
        blk = OOK_Modulator_Python(2,1,2)
    ...
    def test_002_OOK(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OOK_Modulator_Python(2,1,3)
        dst = blocks.vector_sink_f()
    ...
    def test_003_OOK(self):
        ...
        src = blocks.vector_source_f(src_data)      
        blk = OOK_Modulator_Python(1.5,0.5,1)
        dst = blocks.vector_sink_f()
...
if __name__ == '__main__':
    gr_unittest.run(qa_OOK_Modulator_Python)
