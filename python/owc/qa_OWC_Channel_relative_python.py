...
try:
    from gnuradio.owc import OWC_Channel_relative_python
except ImportError:
    import os
    import sys
    dirname, filename = os.path.split(os.path.abspath(python/OWC_Channel_relative_python.py))
    sys.path.append(os.path.join(dirname, "bindings"))
    from gnuradio.owc import OWC_Channel_relative_python

class qa_OWC_Channel_relative_python(gr_unittest.TestCase):
